import { getVotingProgramId, getGreetInstruction } from '@project/anchor'
...
export function useGetProgramAccountQuery() {
  ...
  return useQuery({
    ...
    queryFn: () => client.rpc.getAccountInfo(getVotingProgramId(cluster.id)).send(),
  })
}

export function useGreetMutation() {
  const programAddress = useVotingProgramId()
